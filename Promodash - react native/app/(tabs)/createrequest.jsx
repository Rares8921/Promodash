...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, ScrollView, Image, Animated, Easing } from "react-native";
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      if (image) {
        ...
        const mimeType = fileExtension === "png" ? "image/png" : "image/jpg";
  ...
  return (
    <View style={[styles.container, theme === "Dark" && styles.darkContainer]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Text style={[styles.label, theme === "Dark" && { color: "#FFD700" }]}>
